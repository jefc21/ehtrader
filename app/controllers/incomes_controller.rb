class IncomesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @income.save
        format.html { redirect_to user_income_new_path, notice: "Income was successfully created." }
        #format.json { render :new, status: :created, location: user_income_new_path }
      else
  ...
  private
    ...
    def income_params
      params.require(:income).permit(:reference_date, :income_doc)
    end
end
