...
class PortionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create portion" do
    assert_difference('Portion.count') do
      post portions_url, params: { portion: { contract_historic_id: @portion.contract_historic_id, number: @portion.number, proof: @portion.proof, status: @portion.status, value: @portion.value } }
    end
  ...
  test "should update portion" do
    patch portion_url(@portion), params: { portion: { contract_historic_id: @portion.contract_historic_id, number: @portion.number, proof: @portion.proof, status: @portion.status, value: @portion.value } }
