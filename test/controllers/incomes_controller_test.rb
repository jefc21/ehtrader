...
class IncomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create income" do
    assert_difference('Income.count') do
      post incomes_url, params: { income: { income_doc: @income.income_doc, reference_date: @income.reference_date } }
    end
  ...
  test "should update income" do
    patch income_url(@income), params: { income: { income_doc: @income.income_doc, reference_date: @income.reference_date } }
